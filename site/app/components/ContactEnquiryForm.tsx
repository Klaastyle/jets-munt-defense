...
export default function ContactEnquiryForm({ compact = false }: { compact?: boolean }) {
  ...
  const copy = {
    es: {
      ...
      sent: "Consulta enviada. JetsMunt responderá usando los datos de contacto indicados.",
      name: "Nombre / empresa",
      ...
      options: ["Selección de motor", "Accesorios", "Servicio técnico", "Distribuidor", "Integración de ingeniería"],
      engine: "Motor / accesorio",
      platform: "Tipo de plataforma",
      timeline: "Plazo",
      notes: "Notas del proyecto",
      placeholder: "Empuje objetivo, ciclo de uso, límites de instalación, ECU/telemetría o síntomas de servicio.",
      consent: "Acepto que JetsMunt contacte conmigo sobre esta consulta técnica.",
    ...
    fr: {
      ...
      sent: "Demande envoyée. JetsMunt répondra avec les coordonnées indiquées.",
      name: "Nom / entreprise",
      ...
      options: ["Sélection moteur", "Accessoires", "Service technique", "Distributeur", "Intégration ingénierie"],
      engine: "Moteur / accessoire",
      platform: "Type de plateforme",
      timeline: "Délai",
      notes: "Notes du projet",
      placeholder: "Poussée cible, cycle d'utilisation, limites d'installation, ECU/télémétrie ou symptômes de service.",
