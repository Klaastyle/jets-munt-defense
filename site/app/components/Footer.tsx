...
const footerGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      ["ECU y telemetria", "/electronics-telemetry"],
      ["Ensayo y validacion", "/testing-validation"],
      ["Fabricacion en Espana", "/manufacturing-in-spain"],
    ],
  },
  {
    title: "Empresa",
...
const footerByLocale = {
  es: {
    ...
    sub: "Motores, accesorios, distribuidores y servicio tecnico para programas de propulsion JetsMunt.",
