...
export const metadata: Metadata = buildMetadata({
  title: "Turboréacteur XM215 PRO | Propulsion UAV de Défense",
  description:
    "Fiche technique et spécifications du turboréacteur XM215 PRO de 215 N avec ECU intégré, contrôle de moteur FOC et télémétrie CAN Bus.",
  path: "/fr/moteurs/xm215-pro",
  image: "/media/215/Gemini_Generated_Image_3o0as33o0as33o0a.png",
  keywords: ["XM215 PRO", "turboreacteur 215 N", "propulsion UAV defense", "microturbine JetsMunt"],
  locale: "fr_FR",
...
export default function Xm215ProPage() {
  const specs = [
    { label: "Poussée Maximale", value: "215 N" },
    { label: "Régime Maximal", value: "122 000 tr/min" },
    { label: "Poids du Moteur", value: "1 820 g" },
    { label: "Poids de la Pompe", value: "65 g" },
    { label: "Poids Total Installé", value: "1 885 g" },
    { label: "Longueur", value: "265 mm" },
    { label: "Diamètre du Corps", value: "73,9 mm" },
    { label: "Diamètre Maximal", value: "112,5 mm" },
    { label: "Hauteur", value: "177,5 mm" },
  ...
  return (
    <SeoPageShell
      ...
      title="XM215 PRO"
      description="Turboréacteur de 215 N avec électronique FADEC et interfaces de télémétrie entièrement intégrées à l'intérieur du corps du moteur."
      image="/media/215/Gemini_Generated_Image_3o0as33o0as33o0a.png"
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <div style={{ position: "relative", width: "100%", background: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "4px", padding: "1rem" }}>
                ...
                <svg viewBox="0 0 400 220" style={{ width: "100%", height: "auto" }}>
                  ...
                  {/* Y Axis Labels */}
                  <text x="35" y="34" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="end">800</text>
                  <text x="35" y="74" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="end">600</text>
                  <text x="35" y="114" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="end">400</text>
                  <text x="35" y="154" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="end">200</text>
                  <text x="35" y="194" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="end">0</text>

                  <text x="345" y="34" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="start">250</text>
                  <text x="345" y="74" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="start">180</text>
                  <text x="345" y="114" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="start">120</text>
                  <text x="345" y="154" fill="rgba(255,255,255,0.5)" fontSize="8" textAnchor="start">60</text>
                  ...
                  {/* Fuel Flow Curve */}
                  <path
                    d="M 63 183.4 L 98 181 L 127 176.2 L 156 171.6 L 214 164.4 L 243 139 L 278 116.8 L 307 98.4 L 336 59.6"
                    fill="none"
                    stroke="#4f92ff"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  {/* Thrust Curve */}
                  <path
                    d="M 63 184.8 L 98 181 L 127 175.9 L 156 170.8 L 214 146.4 L 243 135.6 L 278 110 L 307 87 L 336 52.4"
                    fill="none"
                    stroke="var(--accent)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  {/* Flow dots */}
                  <circle cx="336" cy="59.6" r="3" fill="#4f92ff" />
                  <circle cx="278" cy="116.8" r="3" fill="#4f92ff" />
                  <circle cx="214" cy="164.4" r="3" fill="#4f92ff" />
                  <circle cx="98" cy="181" r="3" fill="#4f92ff" />

                  {/* Thrust dots */}
                  <circle cx="336" cy="52.4" r="3" fill="var(--accent)" />
                  <circle cx="278" cy="110" r="3" fill="var(--accent)" />
                  <circle cx="214" cy="146.4" r="3" fill="var(--accent)" />
                  <circle cx="98" cy="181" r="3" fill="var(--accent)" />
                </svg>
              </div>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2.5rem" }} className="desktop-grid-2">
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                {[
                  { src: "/media/215/Gemini_Generated_Image_gk1dtrgk1dtrgk1d.png", alt: "XM215 PRO vue latérale" },
                  { src: "/media/215/Gemini_Generated_Image_lpf18glpf18glpf1.png", alt: "XM215 PRO vue frontale diffuseur et compresseur" },
                  { src: "/media/215/Gemini_Generated_Image_t6c0vit6c0vit6c0.png", alt: "XM215 PRO intégration électronique interne" },
                  { src: "/media/215/Gemini_Generated_Image_3o0as33o0as33o0a.png", alt: "XM215 PRO système d'échappement" },
                ].map((img, i) => (
            ...
            <div style={{ background: "#05070a", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "6px", padding: "1rem", fontFamily: "monospace", color: "#4f92ff" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                <div style={{ border: "1px solid rgba(255,255,255,0.05)", padding: "0.6rem", borderRadius: "4px" }}>
                  ...
                  <div style={{ fontSize: "1.4rem", fontWeight: "bold", color: "var(--accent)" }}>122 000 <span style={{ fontSize: "0.8rem" }}>RPM</span></div>
                </div>
                <div style={{ border: "1px solid rgba(255,255,255,0.05)", padding: "0.6rem", borderRadius: "4px" }}>
                  <div style={{ fontSize: "0.7rem", color: "var(--text-muted)" }}>TEMP ÉCHAPPEMENT</div>
                  <div style={{ fontSize: "1.4rem", fontWeight: "bold", color: "#fff" }}>680 <span style={{ fontSize: "0.8rem" }}>°C</span></div>
                </div>
              </div>
