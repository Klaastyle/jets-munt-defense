...
export default function Xm215ProPage() {
  const specs = [
    { label: "Empuje Máximo", value: "215 N" },
    { label: "RPM Máximas", value: "122.000 rpm" },
    { label: "Peso del Motor", value: "1.820 g" },
    { label: "Peso de la Bomba", value: "65 g" },
    { label: "Peso Total Instalado", value: "1.885 g" },
    { label: "Longitud", value: "265 mm" },
    { label: "Diámetro Cuerpo", value: "73,9 mm" },
    { label: "Diámetro Máximo", value: "112,5 mm" },
  ...
  const integrationFeatures = [
    {
      ...
      desc: "Instalación simplificada al alojar el módulo ECU y FADEC en el propio chasis.",
      icon: (
    ...
    },
    {
      ...
      desc: "Transmisión y recepción robustas compatibles con buses de aviónica complejos.",
      icon: (
        <svg style={{ width: "24px", height: "24px", stroke: "var(--accent)", fill: "none", strokeWidth: 1.5 }} viewBox="0 0 24 24">
    ...
    },
    {
      ...
      desc: "Historial completo de vuelos registrado localmente a alta frecuencia (50 Hz).",
      icon: (
        <svg style={{ width: "24px", height: "24px", stroke: "var(--accent)", fill: "none", strokeWidth: 1.5 }} viewBox="0 0 24 24">
    ...
    },
    {
      ...
      desc: "Enlace opcional inmune a interferencias electromagnéticas extremas y pulsos de RF.",
      icon: (
        <svg style={{ width: "24px", height: "24px", stroke: "var(--accent)", fill: "none", strokeWidth: 1.5 }} viewBox="0 0 24 24">
    ...
    >
      <section className="section container" style={{ paddingBottom: "3rem" }}>
        ...
        <div style={{ gap: "2.5rem", marginBottom: "4rem" }} className="desktop-grid-35-65">
          ...
          <div style={{ background: "rgba(255,255,255,0.01)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "6px", padding: "1.8rem" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2rem" }} className="desktop-grid-2">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2.5rem" }} className="desktop-grid-2">
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                {[
                  { src: "/media/215/Gemini_Generated_Image_gk1dtrgk1dtrgk1d.png", alt: "XM215 PRO vista lateral de la carcasa" },
                  { src: "/media/215/Gemini_Generated_Image_lpf18glpf18glpf1.png", alt: "XM215 PRO vista frontal del difusor y compresor" },
                  { src: "/media/215/Gemini_Generated_Image_t6c0vit6c0vit6c0.png", alt: "XM215 PRO integración electrónica interna" },
                  { src: "/media/215/Gemini_Generated_Image_3o0as33o0as33o0a.png", alt: "XM215 PRO sistema de escape y tobera" },
                ].map((img, i) => (
