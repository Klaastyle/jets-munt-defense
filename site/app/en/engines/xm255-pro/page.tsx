          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2.5rem" }} className="desktop-grid-2">
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                {[
                  { src: "/media/255/Gemini_Generated_Image_onajxeonajxeonaj.png", alt: "XM255 PRO casing side view" },
                  { src: "/media/255/Gemini_Generated_Image_q0loh8q0loh8q0lo.png", alt: "XM255 PRO diffuser front view" },
                  { src: "/media/255/Gemini_Generated_Image_vs8tv5vs8tv5vs8t.png", alt: "XM255 PRO internal electronics integration" },
                  { src: "/media/255/Gemini_Generated_Image_a79y7wa79y7wa79y.png", alt: "XM255 PRO exhaust and nozzle system" },
                ].map((img, i) => (
