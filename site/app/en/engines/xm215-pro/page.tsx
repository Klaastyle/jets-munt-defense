...
export const metadata: Metadata = buildMetadata({
  title: "XM215 PRO Turbojet Engine | UAV Advanced Propulsion",
  description:
...
export default function Xm215ProPage() {
  const specs = [
    { label: "Max. Thrust", value: "215 N" },
    { label: "Max. RPM", value: "122,000 rpm" },
    { label: "Engine Weight", value: "1,820 g" },
    { label: "Fuel Pump Weight", value: "65 g" },
    { label: "Total Installed Weight", value: "1,885 g" },
    { label: "Length", value: "265 mm" },
    { label: "Body Diameter", value: "73.9 mm" },
    { label: "Max. Diameter", value: "112.5 mm" },
    { label: "Height", value: "177.5 mm" },
